...
Then('a mp3 audio player and text box will be displayed alongside picture') do
  ...
  expect(page).to have_selector('#picture') # Assuming the other pictures are hidden
...
When('I want to express my emotions in writing') do
  fill_in 'Write down your thoughts...', with: 'I feel excited' # Assuming 'Emotion' is the name or placeholder of the text input field
end

Then('text will be shown in the text box as accordance to user input') do
  expect(page).to have_field('Write down your thoughts...', with: 'I feel excited') # Assuming 'Emotion' is the name or placeholder of the text input field
end
