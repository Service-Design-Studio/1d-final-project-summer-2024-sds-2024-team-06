...
RSpec.describe EchoesJournal, type: :model do
  ...
  it "is valid with valid attributes" do
      echoes_journal = EchoesJournal.create(imageURL: file_url, journal_title: "My Gallery Journal", journal_entry: "A beautiful sunset.", tip_title:"yes", tip_body: "no", user: user)
      echoes_journal.save
